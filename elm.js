...
var $author$project$Main$init = {currentPage: $author$project$Main$Home};
...
var $author$project$Main$header = A2(
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$elm$html$Html$text('My Portfolio')
				])),
			A2(
			$elm$html$Html$nav,
			_List_Nil,
...
var $author$project$Main$homeView = A2(
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$elm$html$Html$text('Explore my projects and feel free to get in touch.')
				]))
		]));
...
var $author$project$Contact$view = A2(
	$elm$html$Html$div,
	_List_Nil,
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$elm$html$Html$text('Feel free to reach out to me!')
				])),
			A2(
			$elm$html$Html$label,
			_List_Nil,
			...
			_List_fromArray(
				[
					$elm$html$Html$Events$onClick($author$project$Contact$Submit)
				]),
			_List_fromArray(
				[
		...
		[
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$text('Project 1: Description of project 1.')
						])),
					A2(
					$elm$html$Html$li,
					_List_Nil,
					_List_fromArray(
						[
							$elm$html$Html$text('Project 2: Description of project 2.')
						])),
					A2(
					$elm$html$Html$li,
					_List_Nil,
					_List_fromArray(
						[
							$elm$html$Html$text('Project 3: Description of project 3.')
						]))
				]))
		]));
		...
		_List_fromArray(
			[
				...
				switch (_v0.$) {
					...
					case 'Projects':
						return $author$project$Projects$view;
					default:
						return A2($elm$html$Html$map, $author$project$Main$ContactMsg, $author$project$Contact$view);
				}
			}()
			]));
};
