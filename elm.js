...
var $author$project$Main$view = function (model) {
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[$mdgriffith$elm_ui$Element$centerX, $author$project$Styles$paddingMedium]),
		_List_fromArray(
			[
				...
				switch (_v0.$) {
					...
					default:
						return A2($mdgriffith$elm_ui$Element$map, $author$project$Main$ContactMsg, $author$project$Contact$view);
				}
			}()
			]));
};
